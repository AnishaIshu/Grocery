  ...
  return (
    <section>
      <div className='pl-[8%] pt-[0.7%] realtive flex justify-between items-center pr-[8%] border-b-[1px] pb-[0.7%]'>
        ...
        <div
          className={`max-lg:absolute max-lg:right-24 max-lg:top-[22.5%] max-md:top-[17%] max-md:right-[2%] max-md:z-10 max-md:transition-all max-md:duration-300 max-md:ease-in max-md:w-0 max-md:bg-slate-200 max-md:overflow-hidden max-md:h-[43.4%] ${
            showNav && "max-md:w-[32%] max-sm:w-[40%] max-lg:z-10"
          }`}
        >
          <ul className='flex text-[17px] space-x-10 pt-5 max-lg:-mt-9 max-lg:text-[15px] font-[700] max-lg:space-x-5 max-md:flex-col max-md:space-x-0 max-md:space-y-4 max-md:text-center'>
